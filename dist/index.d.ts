...
declare type ToolbarColumnDisplayType = {
    columnChecked: ColumnChecked[];
    handleToggleCheck: (col: ColumnChecked) => () => void;
};
...
declare type TableHeadPropsType = {
    numSelected: number;
    order: 'desc' | 'asc';
    orderBy: string;
    rowCount: number;
...
export type { toolbarOptions, Order, IColumn, IGenericDataTable, ChipData, TableHeadPropsType, ITableToolbar, ToolbarFilter, ToolbarColumnDisplayType, };
